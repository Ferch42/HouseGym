...
class HouseGym_2(gym.Env):
    ...
    def __init__(self):
        ...
        self.tasks = [
            ...
            ('UNTIL', ('AND', 'Light', ('AND', ('NOT', 'Music'), ('NOT', 'Monkey'))), ('AND', 'Radio', ('NEXT', ('UNTIL', ('AND', 'Light', ('AND', 'Music', ('NOT', 'Monkey'))), ('AND', 'LightSwitch', ('NEXT', ('UNTIL', ('AND', ('NOT', 'Light'), ('AND', 'Music', ('NOT', 'Monkey'))), ('AND', 'Ball', ('NEXT', ('AND', ('NOT', 'Light'), ('AND', 'Music', 'Monkey')))))))))))
        ]
